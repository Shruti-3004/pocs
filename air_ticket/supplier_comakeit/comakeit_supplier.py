...
class ComakeitSupplier:
    ...
    def get_result(self):
        ...
        for e_file in ensemble_output_files:
            ...
            with open(e_file) as fp:
                ...
                for out in outputs:
                    ...
                    asset_names = data[0]
                    item_names = data[1]
                    spent_amounts = data[2]
                    currency_codes = data[3]
                    quantities = data[4]
                    units = data[5]
                    spent_dates = data[6]
                    suppliers = data[7]
                    ...
                    if spent_amounts and not spent_amount_final:
                        spent_amount_final = spent_amounts

                    if currency_codes and not currency_code_final:
                        currency_code_final = currency_codes
                    ...
                    if spent_dates and not spent_date_final:
                        spent_date_final = spent_dates

                    if suppliers and not suppliers_final:
                        suppliers_final = suppliers
        ...
        result["line_items"][0][0]["item_name"] = item_names_final
        result["line_items"][0][0]["s_no"] = 1
        result["line_items"][0][0]["quantity"] = quantities_final
        result["line_items"][0][0]["unit_of_measure"] = units_final
        result["phone"] = None
